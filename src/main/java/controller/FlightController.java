...
public class FlightController {
	...
	public String addF(String fName,int fMoney,int fSeatnum,String fFromcity,String fTocity,String fStarttime,String fEndtime) {
		Flight flight = new Flight(fName,fFromcity,fTocity,fMoney,fSeatnum,DateUtil.toDate("HH:mm:ss", fStarttime),DateUtil.toDate("HH:mm:ss", fEndtime));
	...
	public String editF(int fId,String fName,int fMoney,int fSeatnum,String fFromcity,String fTocity,String fStarttime,String fEndtime) {
		Flight flight = new Flight(fId,fName,fFromcity,fTocity,fMoney,fSeatnum,DateUtil.toDate("HH:mm:ss", fStarttime),DateUtil.toDate("HH:mm:ss", fEndtime));
