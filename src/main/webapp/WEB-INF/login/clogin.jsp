...
<head>
	...
	<script src="/airsys/assets/js/clogin.js"></script>
	 <link rel="stylesheet" href="/airsys/assets/css/clogin.css">
</head>
<body>
    <form action="#" method="POST" class="zong" >
        <p class="p1" style="width:100%;height:32px;font-weight: 600;font-size: 22px;margin:15px 0 10px;">营业员登录</p>
        ...
        <button type="submit" class="btn btn-success" style="margin-left:10%;width:80%;margin-bottom:20px;" ><a href="#" onclick=clerkerLookFlight(${f.fId})>登录</a></button>
    </form>
</body>
</html>